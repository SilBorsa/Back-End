...
public class EstudioTicController {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEstudioTic dtoTic){
        ...
        EstudioTic tic = new EstudioTic (dtoTic.getIdPersona(), 
                                         dtoTic.getNombreInstTic(), 
                                         dtoTic.getPeriodoTic(), 
                                         dtoTic.getCursoTic(), 
                                         dtoTic.getUrlInstTic(), 
                                         dtoTic.getUrl_imgTic());
        ticService.save(tic);

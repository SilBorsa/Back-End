...
public class EstudioController {
    ...
    //Edicion
    @GetMapping("/detailEdu/{idEstudio}")
    ...
    public ResponseEntity<?> create(@RequestBody dtoEstudioFormal dtoEdu){
        ...
        EstudioFormal edu = new EstudioFormal (dtoEdu.getIdPersona(), 
                                               dtoEdu.getNombreInstituto(), 
                                               dtoEdu.getPeriodoEstudio(), 
                                               dtoEdu.getTituloEstudio(), 
                                               dtoEdu.getUrlInstituto(), 
                                               dtoEdu.getUrl_imgInst());
        eduService.save(edu);

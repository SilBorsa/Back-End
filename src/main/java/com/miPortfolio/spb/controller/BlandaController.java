...
public class BlandaController {
    ...
    //detallar
    @GetMapping("/detailSoft/{idBlanda}")
    ...
    public ResponseEntity<?> create(@RequestBody dtoBlanda dtoBlanda){
        ...
        Blandas blanda = new Blandas (dtoBlanda.getIdPersona(), 
                                      dtoBlanda.getNombreBlanda(), 
                                      dtoBlanda.getColorBlanda(),
                                      dtoBlanda.getUrl_imgBlanda());
    ...
    public ResponseEntity<?> update(@PathVariable("idBlanda") int idBlanda, @RequestBody dtoBlanda dtoBlanda){
        ...
        blandaService.save(blanda);
        return new ResponseEntity(new Mensaje("Habilidades blandas actualizada!"), HttpStatus.OK);
    }

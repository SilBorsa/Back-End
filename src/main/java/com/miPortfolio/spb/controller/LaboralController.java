...
public class LaboralController {
    ...
    //Edicion
    @GetMapping("/detailLab/{idLaboral}")
    ...
    public ResponseEntity<?> create(@RequestBody dtoLaboral dtoLab){
        ...
        Laboral lab = new Laboral (dtoLab.getIdPersona(), 
                                   dtoLab.getPeriodoEmpresa(),                   
                                   dtoLab.getNombreEmpresa(), 
                                   dtoLab.getUrlEmpresa(), 
                                   dtoLab.getUrl_imgLab(),
                                   dtoLab.getDescEmpresa());
        labService.save(lab);
